...
<!--//fonts-->
    ...
    <body>
        <%
           ...
           System.out.println("Connecting to DB ....Main Page.....");
		...
		<div class="container">
                    <nav class="navbar navbar-default">
                        <div class="navbar-header navbar-left">
                            ...
                            <h1><a class="navbar-brand" href="index.jsp">XYZ <span>HOTEL</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
                        </div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">XYZ HOTEL</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our XYZ HOTEL</h3> 
						   <p class="about-para-w3ls">We provide best luxary life in City</p>
					...
					<ul class="slides">
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Loved everyhthing about it </p>
								<h5>Julia Rose</h5>
								<p>Germany</p>
							</div>
							<div class="clearfix"> </div>
	...
	<div class="container">
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile2" data-aos="flip-left">
          ...
          <%!
               ...
               String approval;
            %>
<!--jsp--><%//JSP for Contact Us    
                    full_name = request.getParameter("name");
                    phone_number = request.getParameter("phone");
                    int ph_no = 0;
                    if(phone_number != null){
                        ph_no = Integer.parseInt(phone_number);
                    }
                    email_addr = request.getParameter("email");
                    approval = "Not Allowed";
                    try{
                        if(full_name !=null && ph_no!=0 && email_addr!=null){
                            DBconnection.stmt.executeUpdate
                            ("INSERT INTO contact (fullname,phoneno,email,approval) VALUES('"+full_name+"',"+ph_no+",'"+email_addr+"','"+approval+"')");
                        }
...
%>
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@XYZHOTEL.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Navi Mumbai,India</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2017 XYZ HOTEL . All Rights Reserved | Design by <a href="#">XYZ HOTEL</a> </p>
		    </div>
